...
const monument = localFont({ src: './Monument.otf' })
    ...
    >
      ...
      ? (
        <div className=" flex flex-col pl-40 pr-40">
          ...
          <div className="flex mt-12 justify-between ">
            ...
            <div className=" h-min flex self-center text-[6.1em]">
              <Image  alt= "good" src={"/good.png"} width={200} height={200} />
              <Image  alt= "good" src={"/good.png"} width={200} height={200} />
            </div>
          </div>
      ...
      {address  ? (
        <div className="absolute z-0 top-24  flex w-[100%] justify-center flex-col ">
          <div className={`${monument.className} flex-col self-center text-center font-[Monument] text-4xl font-bold text-purple-400`}>
            That&apos;s more like it!
          </div>
        </div>
      ): (
